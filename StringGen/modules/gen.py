...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@Call_me_futurepilot"))
        else:
            ...
            await client.join_chat("Call_me_futurepilot")
    except KeyError:
        pass
    try:
